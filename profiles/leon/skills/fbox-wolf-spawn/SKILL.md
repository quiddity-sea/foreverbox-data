...
## Related References
- `references/two-wolf-protocols.md` — Clarifies the distinction between this Research Wolf system and the Forever Fit Wolf Protocol (gamification, The Hunt, Den Integrity). These are two completely different systems sharing the "Wolf" name.
