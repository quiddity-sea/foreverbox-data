...
class ValidationHandler {
    ...
    async validateTextDocument(textDocument) {
        ...
        const diagnosticResults = await this.languageService.doValidation(textDocument, (0, isKubernetes_1.isKubernetesAssociatedDocument)(textDocument, this.yamlSettings.specificValidatorPaths));
        const diagnostics = [];
