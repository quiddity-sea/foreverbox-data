import type { CompletionItem, CompletionItemKind, InsertTextFormat, SymbolKind, SymbolInformation } from 'vscode-languageserver-types';
import { Diagnostic, DiagnosticSeverity, DocumentSymbol } from 'vscode-languageserver-types';
...
export declare function createDiagnosticWithData(message: string, startLine: number, startCharacter: number, endLine: number, endCharacter: number, severity: DiagnosticSeverity, source: string, schemaUri: string | string[], code?: string | number, data?: Record<string, unknown>): Diagnostic;
...
export declare function createExpectedCompletion(label: string, insertText: string, startLine: number, startCharacter: number, endLine: number, endCharacter: number, kind: CompletionItemKind, insertTextFormat?: InsertTextFormat, extra?: Partial<CompletionItem>): CompletionItem;
