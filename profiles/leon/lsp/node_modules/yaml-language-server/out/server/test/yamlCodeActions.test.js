...
# comment`);
    ...
    describe('Enum value or property mismatch quick fix', () => {
        it('should generate proper action for enum mismatch', () => {
            ...
            const diagnostic = (0, verifyError_1.createDiagnosticWithData)('message', 0, 5, 0, 11, vscode_languageserver_types_1.DiagnosticSeverity.Hint, 'YAML', 'schemaUri', jsonLanguageTypes_1.ErrorCode.EnumValueMismatch, { values: ['valueX', 'valueY'] });
            const params = {
        ...
        it('should generate proper action for wrong property', () => {
            const doc = (0, testHelper_1.setupTextDocument)('foo: value1');
            const diagnostic = (0, verifyError_1.createDiagnosticWithData)('message', 0, 0, 0, 3, vscode_languageserver_types_1.DiagnosticSeverity.Hint, 'YAML', 'schemaUri', jsonLanguageTypes_1.ErrorCode.PropertyExpected, {
        ...
        it('should generate proper action for enum mismatch, title converted to string value', () => {
            const doc = (0, testHelper_1.setupTextDocument)('foo: value1');
            const diagnostic = (0, verifyError_1.createDiagnosticWithData)('message', 0, 5, 0, 11, vscode_languageserver_types_1.DiagnosticSeverity.Hint, 'YAML', 'schemaUri', jsonLanguageTypes_1.ErrorCode.EnumValueMismatch, { values: [5, 10] });
            const params = {
                context: vscode_languageserver_types_1.CodeActionContext.create([diagnostic]),
                range: undefined,
                textDocument: vscode_languageserver_types_1.TextDocumentIdentifier.create(testHelper_1.TEST_URI),
        ...
        it('should generate proper action for enum with escaped quote strings', () => {
            const doc = (0, testHelper_1.setupTextDocument)('foo: value1');
            const diagnostic = (0, verifyError_1.createDiagnosticWithData)('message', 0, 5, 0, 11, vscode_languageserver_types_1.DiagnosticSeverity.Hint, 'YAML', 'schemaUri', jsonLanguageTypes_1.ErrorCode.EnumValueMismatch, { values: ['', '""', "''"] });
            const params = {
                context: vscode_languageserver_types_1.CodeActionContext.create([diagnostic]),
                range: undefined,
                textDocument: vscode_languageserver_types_1.TextDocumentIdentifier.create(testHelper_1.TEST_URI),
