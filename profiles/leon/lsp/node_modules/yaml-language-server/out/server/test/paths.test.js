...
const checkBadPath = (path) => {
    it('Rejects "' + path + '"', () => {
        (0, assert_1.default)(!(0, paths_1.isRelativePath)(path));
    });
};
const checkGoodPath = (path, expect1, expect2, expect3) => {
    describe('Relative path = "' + path + '"', () => {
        ...
        it('Resolves relative path in single-root workspace', () => {
            assert_1.default.equal(ws1.resolve(path), expect1);
        });
        it('Resolves relative path in multi-root workspace', () => {
            assert_1.default.equal(ws2.resolve(path), expect2);
        });
        it('Resolves relative path in multi-root nested workspace', () => {
            assert_1.default.equal(ws3.resolve(path), expect3);
        });
    });
};
    ...
    describe('Recognises and correctly resolves relative paths', () => {
        ...
        describe('Relative path = a workspace folder', () => {
            ...
            it('Recognises relative path "' + path1 + '"', () => {
                (0, assert_1.default)((0, paths_1.isRelativePath)(path1));
            });
            it('Resolves "' + path1 + '" in single-root workspace', () => {
                assert_1.default.equal(ws1.resolve(path1), 'file:///home/aFolder/file.json');
            });
            it('Resolves "' + path2 + '" in multi-root workspace', () => {
                assert_1.default.equal(ws2.resolve(path2), 'file:///usr/testuser/projects/workspace/folder-2/file.json');
            });
            it('Resolves "' + path3 + '" in multi-root nested workspace', () => {
                assert_1.default.equal(ws3.resolve(path3), 'file:///c%3A/Users/testuser/dev/carrots/file.json');
            });
            it('Resolves "' + path4 + '" in multi-root nested workspace', () => {
                assert_1.default.equal(ws4.resolve(path4), 'file:///c%3A/Users/testuser/dev/test/test.json');
            });
        });
        describe('Path with mixed delimiters (Windows only)', () => {
            ...
            it('Resolves "' + path + '" in single-root workspace', function () {
                if (process.platform !== 'win32') {
                    ...
                    assert_1.default.equal(ws1.resolve(path), 'file:///home/aFolder/some/strange/but/functional/path/file.json');
                }
            });
            it('Resolves "' + path + '" in multi-root workspace', function () {
                if (process.platform !== 'win32') {
                    ...
                    assert_1.default.equal(ws2.resolve(path), 'file:///usr/testuser/projects/workspace/some/strange/but/functional/path/file.json');
                }
            });
            it('Resolves "' + path + '" in multi-root nested workspace', function () {
                if (process.platform !== 'win32') {
                    ...
                    assert_1.default.equal(ws3.resolve(path), 'file:///c%3A/Users/testuser/dev/potatoes/some/strange/but/functional/path/file.json');
                }
            });
        });
        describe('Tests for workspaceFoldersChanged', () => {
            it('workspaceFolders are added correctly', () => {
                ...
                assert_1.default.equal(newWorkspaceFolders.length, 4);
                assert_1.default.equal(newWorkspaceFolders[0].name, 'folder-1');
                assert_1.default.equal(newWorkspaceFolders[0].uri, 'file:///usr/testuser/projects/workspace/folder-1/');
                assert_1.default.equal(newWorkspaceFolders[1].name, 'folder-2');
                assert_1.default.equal(newWorkspaceFolders[1].uri, 'file:///usr/testuser/projects/workspace/folder-2/');
                assert_1.default.equal(newWorkspaceFolders[2].name, 'folder-3');
                assert_1.default.equal(newWorkspaceFolders[2].uri, 'file:///usr/testuser/projects/workspace/folder-3/');
                assert_1.default.equal(newWorkspaceFolders[3].name, 'folder-4');
                assert_1.default.equal(newWorkspaceFolders[3].uri, 'file:///usr/testuser/projects/workspace/folder-4/');
            });
            it('workspaceFolders are not added if duplicate uri', () => {
                ...
                assert_1.default.equal(newWorkspaceFolders.length, 3);
                assert_1.default.equal(newWorkspaceFolders[0].name, 'folder-1');
                assert_1.default.equal(newWorkspaceFolders[0].uri, 'file:///usr/testuser/projects/workspace/folder-1/');
                assert_1.default.equal(newWorkspaceFolders[1].name, 'folder-2');
                assert_1.default.equal(newWorkspaceFolders[1].uri, 'file:///usr/testuser/projects/workspace/folder-2/');
            ...
            it('workspaceFolders are removed correctly', () => {
                ...
                assert_1.default.equal(newWorkspaceFolders.length, 2);
                assert_1.default.equal(newWorkspaceFolders[0].name, 'folder-1');
                assert_1.default.equal(newWorkspaceFolders[0].uri, 'file:///usr/testuser/projects/workspace/folder-1/');
                assert_1.default.equal(newWorkspaceFolders[1].name, 'folder-2');
                assert_1.default.equal(newWorkspaceFolders[1].uri, 'file:///usr/testuser/projects/workspace/folder-2/');
