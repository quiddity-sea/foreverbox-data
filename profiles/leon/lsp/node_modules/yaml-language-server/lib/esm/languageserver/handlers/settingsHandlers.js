...
export class SettingsHandler {
    ...
    updateConfiguration() {
        ...
        if (this.yamlSettings.yamlDisableSchemaDetection) {
            if (Array.isArray(this.yamlSettings.yamlDisableSchemaDetection)) {
                languageSettings = this.configureSchemas(EMPTY_SCHEMA_URL, this.yamlSettings.yamlDisableSchemaDetection, true, languageSettings, SchemaPriority.SchemaDetectionDisabled);
            }
        }
    ...
    configureSchemas(uri, fileMatch, schema, languageSettings, priorityLevel) {
        uri = checkSchemaURI(this.yamlSettings.workspaceFolders, this.yamlSettings.workspaceRoot, uri, this.telemetry, this.yamlSettings.kubernetesVersion);
        if (schema === null) {
