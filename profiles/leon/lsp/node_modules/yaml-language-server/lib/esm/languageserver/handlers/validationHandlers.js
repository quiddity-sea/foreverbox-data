...
export class ValidationHandler {
    ...
    async validateTextDocument(textDocument) {
        ...
        const diagnosticResults = await this.languageService.doValidation(textDocument, isKubernetesAssociatedDocument(textDocument, this.yamlSettings.specificValidatorPaths));
        const diagnostics = [];
