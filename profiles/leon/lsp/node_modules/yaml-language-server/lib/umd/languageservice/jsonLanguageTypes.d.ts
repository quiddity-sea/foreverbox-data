...
export interface PromiseConstructor {
     ...
     */
    new <T>(executor: (resolve: (value?: T | PromiseLike<T | undefined>) => void, reject: (reason?: unknown) => void) => void): PromiseLike<T | undefined>;
    /**
...
export declare const ClientCapabilities: {
