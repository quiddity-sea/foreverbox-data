...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./jsonDocument", "yaml", "./yamlParser07", "../jsonLanguageTypes", "./ast-converter", "../utils/arrUtils", "../utils/yamlAstUtils", "../utils/strings"], factory);
    }
    ...
    class SingleYAMLDocument extends jsonDocument_1.JSONDocument {
        ...
        get documentHeaderComments() {
            return this._documentHeaderComments;
        }
        set documentHeaderComments(val) {
