...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "yaml", "../utils/customTags", "./jsonDocument"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.aliasDepth = void 0;
    ...
    function convertAST(parent, node, doc, lineCounter) {
        ...
        else if ((0, yaml_1.isAlias)(node) && exports.aliasDepth.currentRefDepth < exports.aliasDepth.maxRefCount) {
            result = convertAlias(node, parent, doc, lineCounter);
        }
        if (result && (0, yaml_1.isNode)(node)) {
            result.customTagReturnType = (0, customTags_1.getCustomTagReturnType)(node);
        }
        return result;
    }
