...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@vscode/l10n", "path", "vscode-languageserver-types", "vscode-uri", "yaml", "../parser/isKubernetes", "../utils/astNodeUtils", "../parser/yaml-documents", "../utils/arrUtils", "../utils/yamlScalar"], factory);
    }
    ...
    class YAMLHover {
        ...
        async getHover(document, position, doc) {
            const offset = document.offsetAt(position);
