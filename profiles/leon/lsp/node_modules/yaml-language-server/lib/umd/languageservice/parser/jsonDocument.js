(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/astNodeUtils", "./schemaValidation/validatorFactory"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.JSONDocument = exports.EnumMatch = exports.ObjectASTNodeImpl = exports.PropertyASTNodeImpl = exports.StringASTNodeImpl = exports.NumberASTNodeImpl = exports.ArrayASTNodeImpl = exports.BooleanASTNodeImpl = exports.NullASTNodeImpl = void 0;
    ...
    class JSONDocument {
        ...
        validate(textDocument, schema) {
            if (!this.root || !schema)
                return null;
            const validator = (0, validatorFactory_1.getValidator)(schema._schemaDraft);
