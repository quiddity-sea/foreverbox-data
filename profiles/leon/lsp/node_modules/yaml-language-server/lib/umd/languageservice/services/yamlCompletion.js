...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "yaml", "../utils/customTags", "../utils/arrUtils", "../utils/indentationGuesser", "../utils/textBuffer", "../utils/json", "../utils/objects", "../parser/isKubernetes", "../parser/schemaValidation/baseValidator", "../utils/yamlAstUtils", "./modelineUtil", "../utils/schemaUtils", "../utils/yamlScalar", "@vscode/l10n"], factory);
    }
    ...
    const customTags_1 = require("../utils/customTags");
    ...
    class YamlCompletion {
            ...
            if (propertySchema) {
                ...
                if (propertySchema.properties) {
                    ...
                    if (type === 'array' && Array.isArray(propertySchema.default)) {
                        ...
                        return (resultText + this.getInsertTemplateForValue(propertySchema.default, indent, { index: 1 }, separatorAfter).trimEnd());
                    }
        ...
        getCustomTagValueCompletions(collector) {
            for (const customTag of this.customTags ?? []) {
                const parsedTag = (0, customTags_1.parseCustomTag)(customTag);
                if (parsedTag) {
