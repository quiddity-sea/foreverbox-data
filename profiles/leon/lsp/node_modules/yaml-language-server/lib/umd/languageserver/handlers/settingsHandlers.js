(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "request-light", "vscode-languageserver", "vscode-languageserver-protocol", "../../languageservice/utils/paths", "../../languageservice/utils/schemaUrls", "../../languageservice/utils/objects", "../../languageservice/yamlLanguageService", "../../requestTypes"], factory);
    }
    ...
    class SettingsHandler {
        ...
        async setConfiguration(settings) {
            ...
            if (settings.yaml) {
                ...
                if (Object.prototype.hasOwnProperty.call(settings.yaml, 'kubernetesVersion')) {
                    const match = typeof settings.yaml.kubernetesVersion === 'string'
        ...
        updateConfiguration() {
            ...
            if (this.yamlSettings.yamlDisableSchemaDetection) {
                if (Array.isArray(this.yamlSettings.yamlDisableSchemaDetection)) {
                    languageSettings = this.configureSchemas(schemaUrls_1.EMPTY_SCHEMA_URL, this.yamlSettings.yamlDisableSchemaDetection, true, languageSettings, yamlLanguageService_1.SchemaPriority.SchemaDetectionDisabled);
                }
            }
            ...
            const shouldRefreshCodeLens = this.schemaSettings !== undefined && !(0, objects_1.equals)(this.schemaSettings, languageSettings.schemas);
        ...
        refreshCodeLens() {
            ...
            this.connection
                .sendRequest(vscode_languageserver_protocol_1.CodeLensRefreshRequest.type)
        ...
        configureSchemas(uri, fileMatch, schema, languageSettings, priorityLevel) {
            uri = (0, schemaUrls_1.checkSchemaURI)(this.yamlSettings.workspaceFolders, this.yamlSettings.workspaceRoot, uri, this.telemetry, this.yamlSettings.kubernetesVersion);
            if (schema === null) {
            ...
            if ((0, schemaUrls_1.isKubernetes)(uri)) {
